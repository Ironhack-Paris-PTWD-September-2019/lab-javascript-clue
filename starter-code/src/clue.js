...
const mrGreen = {
    ...
    // Rooms
    let diningRoom = {name:"diningRoom"}
    ...
    function randomSelector(cardsArray){
        let selectedCard = cardsArray[Math.floor(Math.random()*cardsArray.length)];
        return selectedCard
    }
    ...
    console.log(`${card1.first_name} ${card1.last_name} killed Mr Boddy using the ${card2.name} in the ${card3.name}`)
    }
    revealMystery();