...
function revealMistery(enveloppe){
    console.log(`${enveloppe[0].first_name} ${enveloppe[0].last_name} killed Mr. Boddy using the ${enveloppe[1].name} in the ${enveloppe[2].name}`);
}
