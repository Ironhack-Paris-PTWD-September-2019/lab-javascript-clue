...
// Rooms Collection
const roomsArray = [];
roomsArray.push(conservatory, diningRoom, kitchen, study, library, billiardRoom, lounge, ballroom, hall, spa, livingRoom, observatory, theater, guestHouse, patio);
...
function randomSelector (stacksArray) {
    ...
    return stacksArray[randomPosition];
}

function pickMystery () {
    let mysteryCharacter = randomSelector(charactersArray);
